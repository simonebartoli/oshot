...
const Dysfunction = () => {
    return (
        <article className="flex flex-col sm:gap-6 gap-10 relative justify-center items-center p-8 py-16">
            ...
            <div className={`flex flex-col gap-16 justify-center items-center sm:p-6 smx:p-2 p-0 smx:py-12 py-2 rounded-lg transition text-lg leading-10`}>
                <div className="flex flex-col gap-16 justify-center items-center lg:w-4/5">
                    <div className="space-y-10">
                        <h3 className="text-2xl font-semibold">Possible Effects</h3>
                        <div className="space-y-6">
                            <div className="flex flex-row items-center gap-4">
                                <AiOutlineSend className="mt-1 basis-1/12"/>
                                <p className="leading-8 basis-11/12">
                                    <span className={"font-semibold text-gold"}>Female Sexual Arousal Disorder</span> (usually but not always accompanies Sexual Desire Disorder). Women who suffer with this may want to have sex but have much difficulty finding the pleasure of arousal
                                </p>
                            </div>
                            <div className="flex flex-row items-center gap-4">
                                <AiOutlineSend className="mt-1 basis-1/12"/>
                                <p className="basis-11/12">
                                    <span className={"font-semibold text-gold"}>Hypoactive Sexual Desire Disorder</span> (Low desire)
                            ...
                            <div className="flex flex-row items-center gap-4">
                                <AiOutlineSend className="mt-1 basis-1/12"/>
                                <p className="basis-11/12">
                                    <span className={"font-semibold text-gold"}>Female Orgasmic Disorder</span>: Here women can become aroused but have much difficulty with orgasm. This can be so frustrating that sex becomes a frustration that they may tend avoid.
                                </p>
                            </div>
                            <div className="flex flex-row items-center gap-4">
                                <AiOutlineSend className="mt-1 basis-1/12"/>
                                <p className="basis-11/12">
                                    <span className={"font-semibold text-gold"}>Dyspareunia</span>: Here the woman suffers with real pain with sex (not from decreased lubrication or vaginal spasm).
                                </p>
                            </div>
                            <div className="flex flex-row items-center gap-4">
                                <AiOutlineSend className="mt-1 basis-1/12"/>
                                <p className="basis-11/12">
                                    <span className={"font-semibold text-gold"}>Urinary Stress Incontinence</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="space-y-10">
                        <h3 className="text-2xl font-semibold">Why Women Suffer Even After Seeing the Gynecologist?</h3>
                        <p>
