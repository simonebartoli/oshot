    ...
    return (
        <main id={"main"} className="flex flex-col p-8 gap-12 items-center">
            ...
            <article className="flex flex-col gap-8 sm:w-3/4 w-full">
                <section className="space-y-6  smx:pl-10 pl-6 py-4 border-l-4 border-gold">
                ...
                <section className="space-y-6">
                    ...
                    <div className="space-y-8 pb-4">
                        ...
                        <div className="flex flex-row items-center gap-8">
                            <span className="text-xl p-2 px-4 bg-gold text-white rounded-md border-2 border-black shadow-lg">1</span>
                            <span>Greater arousal from clitoral stimulation</span>
                        </div>
                        <div className="flex flex-row items-center gap-8">
                            <span className="text-xl p-2 px-4 bg-gold text-white rounded-md border-2 border-black shadow-lg">2</span>
                            <span>Find excellent counseling about the female orgasm system from counselors who understand this concept.</span>
                        </div>
                        <div className="flex flex-row items-center gap-8">
                            <span className="text-xl p-2 px-4 bg-gold text-white rounded-md border-2 border-black shadow-lg">3</span>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex flex-row items-center gap-4">
                                <AiOutlineSend className="mt-1 basis-[5%] text-purple"/>
