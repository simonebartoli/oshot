                ...
                <article className="flex flex-col gap-10 items-center">
                    ...
                    <div className="flex flex-row justify-center lg:gap-16 gap-8 flex-wrap">
                        <div className="flex flex-row gap-4 items-center">
                            ...
                            <a className="text-xl hover-underline-animation hover:text-green-600 transition" href="tel:+4402074675340">+44-0207-467-5340</a>
                        </div>
                        <div className="flex flex-row gap-4 items-center">
                            <BsTelephoneInbound className="text-xl"/>
                            <a className="text-xl hover-underline-animation hover:text-green-600 transition" href="tel:+4402074675340">+44-0777-667-7769</a>
                        </div>
                        <div className="flex flex-row gap-4 items-center">
                            <MdOutlineAlternateEmail className="text-xl"/>
                            <a className="text-xl hover-underline-animation hover:text-green-600 transition" href={"mailto: email@domain.com"}>email@domain.com</a>
                        </div>
                    </div>
                </article>
                ...
                <section className="flex lg:flex-row flex-col lg:gap-24 gap-12">
                    <article className="flex flex-col gap-8 basis-1/3 grow">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <a target="_blank" rel="noreferrer" className="text-lg text-center hover-underline-animation hover:text-green-600 transition" href="https://www.google.com/maps/place/Dr+SW+Plastic+Surgery+London/@51.519817,-0.147625,17z/data=!4m5!3m4!1s0x0:0x8943ef774b03be2a!8m2!3d51.519817!4d-0.147625?hl=en">“77 Harley Street, London W1G 9QD”</a>
                        </div>
                        <iframe
                            className="min-h-[400px] lg:min-h-fit h-full rounded-b-lg border-2 border-t-4 border-black border-t-green-600 shadow-xl"
