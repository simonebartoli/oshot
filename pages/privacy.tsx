...
const Privacy = () => {
    return (
        <main id="main" className="flex flex-col items-center p-8 gap-12 pb-16">
            <Head>
                <title>Privacy - Oshot UK</title>
                <meta name="description" content={"In this page you will find the terms and conditions of our service."}/>
                <meta name="keywords" content="terms, conditions, privacy, condition"/>
            ...
            <article className="flex flex-col gap-8 sm:w-3/4 w-full px-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-row items-center gap-4">
                            <AiOutlineSend className="mt-1"/>
                            <span>How To Access Or Correct Your Information</span>
                        </div>
                    </div>
                </div>
                <div className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col gap-6 pt-2">
                        ...
                        <div className="flex flex-row items-center gap-4">
                            <AiOutlineSend className="mt-1"/>
                            <span>Credit/Debit Card Information</span>
                        </div>
                        <div className="flex flex-row items-center gap-4">
                            <AiOutlineSend className="mt-1"/>
                            <span>(etc.)</span>
