...
const Dysfunction: NextPage<Props> = ({selected}) => {
    return (
        <article className="flex flex-col sm:gap-6 gap-10 relative">
            ...
            <h2 className={`text-2xl transition font-semibold ${selected ? "text-green-600" : "text-neutral-500"} sm:text-left text-center`}>Sexual Dysfunction</h2>
            <div className={`flex flex-col gap-16 justify-center items-center smx:border-2 ${selected ? "border-green-600" : "border-neutral-500"} sm:p-6 smx:p-10 p-0 smx:py-12 py-2 rounded-lg transition`}>
