...
import HomePageImage from "../../public/media/photos/index/home3.jpg"
    ...
    return (
        <section ref={fullPageRef} className="relative w-full home-container flex flex-col items-center justify-around">
            ...
            <div className="w-full h-full absolute homepage-image">
                <Image alt="Nude Woman" placeholder="blur" priority={true} src={HomePageImage} objectPosition={"right"} layout="fill" objectFit="cover"/>
            </div>
            <div className="p-4">
                <Image alt="O-Concept Logo" src={ConceptImage}/>
            </div>
            <div className="z-10 flex flex-col items-center gap-8 p-8">
                <h1 className="stroke-text text-gold sm:text-8xl smxl:text-7xl smx:text-6xl text-5xl font-homeTitle font-bold text-center leading-[5rem]">THE O-SHOT</h1>
                <div>
                    <span className="text-gold sm:text-4xl smxl:text-3xl smxl:inline-block block py-1 text-2xl text-center">By Award Winner&nbsp;</span>
                    <span className="text-gold sm:text-4xl smxl:text-3xl smxl:inline-block block py-1 text-2xl text-center font-semibold underline underline-offset-8">Dr. Sherif Wakil</span>
                </div>
            </div>
        </section>
    );
